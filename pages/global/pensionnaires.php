...
<div class='row no-gutters'>
    <div class="col-12 col-lg-6">
        <div class='row border border-dark rounded-lg m-2 align-items-center perso_bgRose' style="height:200px;">
            <div class="col p-2 text-center">
                <img src='../../sources/images/Animaux/chat/odin/odin.jpg' class="img-thumbnail" style="max-height:180px;" alt="Framboise" />
            </div>
    ...
    <div class="col-12 col-lg-6">                <div class="mb-2">Né : XX/XX/XXXX</div>
                <div class="my-3">
    ...
    <div class="col-12 col-lg-6">
        <div class='row border border-dark rounded-lg m-2 align-items-center perso_bgRose' style="height:200px;">
            <div class="col p-2 text-center">
                <img src='../../sources/images/Animaux/chat/framboise/famboise.jpg' class="img-thumbnail" style="max-height:180px;" alt="Framboise" />
            </div>
            <div class="col-2 border-left border-right border-dark text-center">
                <img src='../../sources/images/Autres/icones/ChienOk.png' class="img-fluid m-1" style="width:50px;" alt="chienOk" />
                <img src='../../sources/images/Autres/icones/ChatOk.png' class="img-fluid m-1" style="width:50px;" alt="chatOk" />
